...
dt_list <- list %>% 
  ...
  dplyr::rename('Person / Org'='Person_Org','Languages'='Tech_Focus') %>% 
  dplyr::select(`Person / Org`, Twitter) 
dt_table <- DT::datatable(dt_list, escape = F, options=list(theme='uikit'))
